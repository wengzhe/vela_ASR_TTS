...
static void key_press_cb(lv_event_t* e)
{
    ...
    lv_textarea_set_text(g_audio_text.ui.textarea, "Key Pressed");
    
    int result2 = aitool_cmd_start_exec(&aitool, 0);
...
static void app_create(void)
{
    ...
    lv_obj_set_flex_align(g_audio_text.ui.root, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
    ...
    lv_obj_set_style_text_font(g_audio_text.ui.title, &lv_font_montserrat_24, 0); // Larger font
    ...
    // Create clear button
    g_audio_text.ui.clear_btnm = lv_button_create(g_audio_text.ui.root);
    lv_obj_set_size(g_audio_text.ui.clear_btnm, LV_PCT(15), LV_PCT(10));
    lv_obj_set_style_bg_color(g_audio_text.ui.clear_btnm, lv_color_hex(0xE74C3C), 0);
    lv_obj_set_style_radius(g_audio_text.ui.clear_btnm, 8, 0);
    
    
    g_audio_text.ui.clear_btnm_text = lv_label_create(g_audio_text.ui.clear_btnm);
    lv_label_set_text(g_audio_text.ui.clear_btnm_text, "Clear");
    lv_obj_set_style_text_color(g_audio_text.ui.clear_btnm_text, lv_color_hex(0xFFFFFFFF), 0);
    lv_obj_center(g_audio_text.ui.clear_btnm_text);
    
    // Create voice button
    g_audio_text.ui.voice_btntnm = lv_button_create(g_audio_text.ui.root);
    lv_obj_set_size(g_audio_text.ui.voice_btntnm, LV_PCT(30), LV_PCT(30));

    lv_obj_set_x(g_audio_text.ui.voice_btntnm, DEMO_WIDTH/2);
    ...
    g_audio_text.ui.voice_btntnm_text = lv_label_create(g_audio_text.ui.voice_btntnm);
    lv_label_set_text(g_audio_text.ui.voice_btntnm_text, "Hold to Speak");
    lv_obj_set_style_text_color(g_audio_text.ui.voice_btntnm_text, lv_color_hex(0xFFFFFFFF), 0);
    lv_obj_set_style_text_font(g_audio_text.ui.voice_btntnm_text, &lv_font_montserrat_18, 0); // Larger font
    lv_obj_center(g_audio_text.ui.voice_btntnm_text);
    ...
    lv_obj_add_event_cb(g_audio_text.ui.clear_btnm, clear_text_cb, LV_EVENT_CLICKED, NULL); // Clear button callback
}
